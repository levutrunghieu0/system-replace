...
function ChecklistIssuePage() {
  ...
  const handleIssue = () => {
    setToast({ open: true, message: t('page.tanazaoroshi.checklist.toast.printing') })
  }
  ...
  return (
    <Box sx={{ display: 'flex', justifyContent: 'center', pt: 4 }}>
      <Paper
        elevation={2}
        sx={{ width: '100%', maxWidth: 520, borderRadius: 2, overflow: 'hidden' }}
      >
        {/* ── Page header ── */}
        ...
        <Box sx={{ p: 3, display: 'flex', flexDirection: 'column', gap: 3 }}>
          ...
          <Box>
            ...
            >
              ...
              {(['shelfScan', 'diffList', 'diffListConfirmed'] as const).map((key) => (
          ...
          <Box>
            <FormLabel
              sx={{ fontSize: '0.875rem', fontWeight: 600, color: 'text.primary', display: 'block', mb: 1.5 }}
            >
